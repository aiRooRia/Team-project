...
export const FoodModal = ({handleClose, open, foodName, discountedPrice, foodPrice, imgUrl, foodIngredients}:TFoodModalProps) =>{
          ...
          <Stack sx={{ m: 0, p: 2 }} spacing={2}>
            <Stack sx={{ m: 0, p: 1 }} spacing={2}>
              <Stack>
                ...
                <Typography variant="body2" color={"black"} sx={{textDecoration: "line-through" }} gutterBottom>
                  {foodPrice}₮
                </Typography>
                </Stack>
